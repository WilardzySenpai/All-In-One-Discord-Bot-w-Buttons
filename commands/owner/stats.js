...
const ownerid = "852924674199519273";
const ownerid2 = "843168022364422144";
...
//command
  if(message.author.id != 852924674199519273){
    const noperms = new MessageEmbed()
    .setDescription("<:astroz_wrong:825598313499459605> This Command Only Use By My Owner **NarutoCodm ")
    .setColor("YELLOW");
...
.setTitle(`**[Support Server]**`)
  ...
  .addFields(
    ...
    { name: "<a:Owner:822760998938869760> Bot Owner:",value: `\`\`\`NarutoCodm\`\`\``},
  )
  .setColor("3498DB")
